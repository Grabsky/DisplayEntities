...
public interface PluginConfiguration {
    ...
    interface Messages {
        ...
        @Order(4) @Key("error.enum_not_found.pose")
        default String errorEnumNotFoundPose() {
            return "<dark_gray>› <red>Argument <yellow>{input}<red> is not a pose.";
        }

        @Order(5) @Key("error.enum_not_found.equipment_slot")
        default String errorEnumNotFoundEquipmentSlot() {
            return "<dark_gray>› <red>Argument <yellow>{input}<red> is not an equipment slot.";
        }

        @Order(6) @Key("error.invalid_boolean")
        ...
        default LinkedHashMap<String, String> commandUsages() {
            return new LinkedHashMap<>() {{
                ...
                put("display.edit.move_here",        "<common_primary>/display edit <common_secondary>(display) <common_primary>move_here");
        ...
        @Order(17) @Key("command.display.help.header")
        ...
        default List<String> commandDisplayHelpContents() {
            return List.of(
                    ...
                    "<dark_gray>› <spec:messages.command_usages.display.edit.move_here>",
        ...
        @Order(20) @Key("command.display.create.success")
        ...
        @Order(21) @Key("command.display.create.failure.invalid_format")
        ...
        @Order(22) @Key("command.display.delete.success")
        ...
        @Order(23) @Key("command.display.respawn.success")
        ...
        @Order(24) @Key("command.display.clone.success")
        ...
        @Order(25) @Key("command.display.clone.failure.invalid_format")
        ...
        @Order(26) @Key("command.display.reload")
        ...
        @Order(27) @Key("command.display.teleport.success")
        ...
        @Order(28) @Key("command.display.export.success")
        ...
        @Order(29) @Key("command.display.export.failure")
        ...
        @Order(30) @Key("command.display.import.success")
        ...
        @Order(31) @Key("command.display.import.failure.invalid_format")
        default String commandDisplayImportFailureInvalidFormat() {
            return "<dark_gray>› <red>Specified name does not match format: [<yellow>0-9 A-Z / . - _<red>]";
        }

        @Order(32) @Key("command.display.import.failure.file_not_found")
        default String commandDisplayImportFailureFileNotFound() {
            return "<dark_gray>› <red>File <yellow>{file}<red> does not exist.";
        }

        @Order(33) @Key("command.display.import.failure.other")
        ...
        @Order(34) @Key("command.display.edit.alignment.success")
        ...
        @Order(35) @Key("command.display.edit.background.success")
        ...
        @Order(36) @Key("command.display.edit.billboard.success")
        ...
        @Order(37) @Key("command.display.edit.scale.success")
        ...
        @Order(38) @Key("command.display.edit.scale.success.mannequin")
        default String commandDisplayEditScaleSuccessMannequin() {
            return "<dark_gray>› <gray>Display scale has been set to <primary>{scale}<gray>.";
        }

        // Display > Edit > View Range

        @Order(39) @Key("command.display.edit.view_range.success")
        ...
        @Order(40) @Key("command.display.edit.block.success")
        ...
        @Order(41) @Key("command.display.edit.block.failure.specified_invalid_type")
        ...
        @Order(42) @Key("command.display.edit.block.failure.holding_invalid_type")
        ...
        @Order(43) @Key("command.display.edit.item.success")
        ...
        @Order(44) @Key("command.display.edit.item.failure.specified_invalid_type")
        ...
        @Order(45) @Key("command.display.edit.add_line.success")
        ...
        @Order(48) @Key("command.display.edit.remove_line.failure.out_of_bounds")
        @Comment("Display > Edit > Remove Line")
        default String commandDisplayEditRemoveLineFailureOutOfBounds() {
            return "<dark_gray>› <red>Line <yellow>{number} <red>is out of bounds. (Max: {max})";
        }

        @Order(49) @Key("command.display.edit.remove_line.success")
        ...
        @Order(50) @Key("command.display.edit.set_line.success")
        ...
        @Order(51) @Key("command.display.edit.set_line.failure.out_of_bounds")
        ...
        @Order(52) @Key("command.display.edit.see_through.success")
        ...
        @Order(53) @Key("command.display.edit.text_shadow.success")
        ...
        @Order(54) @Key("command.display.edit.text_opacity.success")
        ...
        @Order(55) @Key("command.display.edit.move_to.success")
        ...
        // Display > Edit > Move Here

        @Order(56) @Key("command.display.edit.move_here.success")
        @Comment("Display > Edit > Move Here")
        default String commandDisplayEditMoveHereSuccess() {
            return "<dark_gray>› <gray>Display has been moved to <primary>{x}<gray>, <primary>{y}<gray>, <primary>{z}<gray>.";
        }

        // Display > Edit > Brightness

        @Order(57) @Key("command.display.edit.brightness.success")
        ...
        @Order(58) @Key("command.display.edit.line_width.success")
        ...
        @Order(59) @Key("command.display.edit.refresh_interval.success")
        ...
        @Order(60) @Key("command.display.edit.refresh_interval.failure")
        ...
        @Order(61) @Key("command.display.edit.rotate_x.success")
        ...
        @Order(62) @Key("command.display.edit.rotate_y.success")
        ...
        @Order(63) @Key("command.display.edit.width.success")
        ...
        @Order(64) @Key("command.display.edit.height.success")
        ...
        @Order(65) @Key("command.display.edit.response.success")
        ...
        @Order(66) @Key("command.display.edit.transform.success")
        ...
        @Order(67) @Key("command.display.edit.glow.color_change.success")
        ...
        @Order(68) @Key("command.display.edit.glow.disabled.success")
        ...
        @Order(69) @Key("command.display.edit.click_command.success")
        ...
        @Order(70) @Key("command.display.edit.custom_name.success")
        ...
        @Order(71) @Key("command.display.edit.description.success")
        ...
        @Order(72) @Key("command.display.edit.equipment.success")
        ...
        @Order(73) @Key("command.display.edit.pose.success")
        ...
        @Order(74) @Key("command.display.edit.skin.success")
        ...
        @Order(75) @Key("command.display.edit.skin.failure.invalid_url")
        ...
        @Order(76) @Key("command.display.edit.track_nearest_player.success")
